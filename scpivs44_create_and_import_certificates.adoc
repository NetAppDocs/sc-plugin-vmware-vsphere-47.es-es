...
Consulta el https://kb.netapp.com/data-mgmt/SnapCenter/SC_KBs/How_to_create_and_or_import_an_SSL_certificate_to_SnapCenter_Plug-in_for_VMware_vSphere["Artículo de la base de conocimientos: Cómo crear o importar un certificado SSL al plugin de SnapCenter para VMware vSphere"].
