...
| Último informe de estado de protección de máquinas virtuales o almacenes de datos | Muestra información general sobre el estado de protección, durante el número de días configurado, para las máquinas virtuales y los almacenes de datos gestionados por el complemento de VMware de SnapCenter. El valor predeterminado es 7 días. Para modificar el valor en el archivo de propiedades, consulta link:scpivs44_modify_configuration_default_values.html["Modifique los valores predeterminados de la configuración"]. Haz clic en una sección o estado del gráfico de protección principal para ver una lista de máquinas virtuales o almacenes de datos con ese estado en la pestaña *Informes*. El informe de estado de protección de máquinas virtuales o almacenes de datos para máquinas virtuales y almacenes de datos protegidos muestra los nombres de las máquinas virtuales o los almacenes de datos que se han respaldado durante el número de días configurado, el nombre de la última copia Snapshot y las horas de inicio y fin de la última ejecución de backup. El informe de estado de protección de máquinas virtuales o almacenes de datos para máquinas virtuales o almacenes de datos no protegidos muestra los nombres de las máquinas virtuales o los almacenes de datos que no tienen ningún backup exitoso durante el número de días configurado. Puedes descargar la tabla del informe en formato HTML o CSV. También puedes descargar los registros de trabajos del Job Monitor para todos los trabajos (no solo los que aparecen en el informe). Este informe se actualiza cada hora cuando se actualiza la caché del complemento. Por lo tanto, es posible que el informe no muestre las máquinas virtuales o los almacenes de datos que se han respaldado recientemente. 
|===