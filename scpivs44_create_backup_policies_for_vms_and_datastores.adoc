...
+
Para obtener información sobre cómo los administradores asignan recursos a los usuarios, consulta la https://docs.netapp.com/us-en/snapcenter/get-started/rbac-snapcenter.html["Información de SnapCenter sobre el uso del control de acceso basado en roles"^].



* Si desea realizar backups coherentes con la máquina virtual, debe tener instaladas y en ejecución VMware Tools. Se necesitan VMware Tools para activar las máquinas virtuales. No se admiten backups consistentes con las máquinas virtuales para máquinas virtuales VVol.
