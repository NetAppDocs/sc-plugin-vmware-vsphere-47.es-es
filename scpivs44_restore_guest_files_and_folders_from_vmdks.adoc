...
. En VMware vSphere Web Client, haga clic en *Guest File Restore* en la lista desplegable secundaria para iniciar el asistente.
...
+
Esta opción utiliza los ajustes de configuración del correo electrónico que se definen al configurar VMware vSphere Web Client en vCenter.
