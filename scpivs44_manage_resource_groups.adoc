...
.Pasos
. En el panel de navegación izquierdo del cliente web de VMware vSphere, haga clic en *grupos de recursos*, luego haga clic con el botón derecho en un grupo de recursos y haga clic en *Suspender* (o haga clic en *Reanudar*).
+
image:scpivs44_image24.png["Error: Falta la imagen gráfica"]
...
.Pasos
. En el panel de navegación izquierdo del cliente web de VMware vSphere, haga clic en *Resource Groups*, después seleccione un grupo de recursos y haga clic en *Delete*.
